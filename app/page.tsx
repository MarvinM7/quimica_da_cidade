...
export default function Home() {
  ...
  const mapSubtitle = 'Mapa da localização dos principais parques urbanos do Recife. - Foto: Reprodução/Áreas Verdes Urbanas E (In)Justiça Socioespacial: um estudo sobre os Parques Urbanos do Recife/IFPE.';
