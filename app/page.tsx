...
export default function Home() {
  ...
  const mapSubtitle = 'Mapa da localização dos principais parques urbanos do Recife. De 13 existentes, 11 estão localizados na Zona Norte e outros dois na Zona Sul. - Foto: Reprodução/Áreas Verdes Urbanas E (In)Justiça Socioespacial: um estudo sobre os Parques Urbanos do Recife/IFPE.';
  ...
  return (
    <main className={styles.main}>
      ...
      <section className={`${styles.section} ${styles.mapSection}`}>
        <Map text1={mapText1} text2={mapText2} title={mapTitle} subtitle={mapSubtitle} />
      </section>
