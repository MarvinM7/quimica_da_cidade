  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.svgContainer}>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 683 973">
          <path className={`${styles.path} ${styles.regiao1}`} d="M231.4,308.5c0,3.1,0.1,6.2,0.1,9.3c0.1,0.5,0.3,1,0.5,1.5l0,0c0.4,1.1,0.7,2.2,0.7,3.3
          ...
          />
          <path className={`${styles.path} ${styles.regiao2}`} d="M638,464.6c16.4,11.9,32.2,24.6,44.6,42c-14.8,0.9-18.5,11.4-22.2,21.7v0c-0.7,2.1-1.5,4.2-2.3,6.2
          ...
          />
          <path className={`${styles.path} ${styles.regiao3}`} d="M252.3,789l-17-11c0-0.1,0-0.7-0.1-1.5c0-0.4-0.1-0.9-0.1-1.4c-0.1-2-0.3-4-0.5-6v0c-0.4-4.4-0.8-8.9-0.8-13.3
          ...
          />
          <path className={`${styles.path} ${styles.regiao4}`} d="M607.7,656.3c-0.6,1.3-1.3,2.6-2,3.9l0,0c-1.5,2.9-3,5.8-3.9,8.8c-3.4,10.7-8.9,20.2-15.6,29.2
          ...
          />
          <path className={`${styles.path} ${styles.regiao5}`} d="M426.7,257c0.6,0.7,1.2,1.4,1.8,2c5.2,5.9,10.4,11.8,19.8,10.9c1.4-0.1,3.1,1.8,4.4,3.2l0.2,0.2
          ...
          />
          <path className={`${styles.path} ${styles.regiao6}`} d="M119.1,611.4c-1.4-0.2-2.7-0.3-4.9-0.2c-1.5,0-2-0.2-2.6-0.5v0c0-0.2,0.1-0.5,0.2-1.3c-0.4-2.1-0.9-3.5-1.4-5
